...
Moving deeply integrated code into the component structure has been proven to be a huge effort. After moving the
\textit{Producer} code to the \textit{Producer} component, it took me en entire week to fix the bugs resulting from this
refactoring and chances are the difficult ones have not even yet been found.

I have made added/removed or changed over 6000 lines of code/data, as git\footnote{GIT website:
...
\textit{ec357d0c3458126375563684070c49f589d99442} and component revision \textit{370699fc2a095e0d95c70edf21cd568362d2aff7}.
